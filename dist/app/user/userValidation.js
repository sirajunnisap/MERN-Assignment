...
const passwordCompare = (plainTextPass, hashedpassword) => __awaiter(void 0, void 0, void 0, function* () {
    const comparepassword = bcrypt_1.default.compare(plainTextPass, hashedpassword);
